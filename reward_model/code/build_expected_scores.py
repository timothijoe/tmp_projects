...
def main() -> None:
    ...
    parser.add_argument(
        "--input",
        default="reward_model/data/reward_candidates/reward_candidates_pairs_with_labels.json",
    ...
    parser.add_argument(
        "--output-csv",
        default="reward_model/data/reward_candidates/reward_candidates_expected_scores.csv",
    )
