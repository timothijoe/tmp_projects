...
def main() -> None:
    ...
    parser.add_argument("--gt-json", default="reward_model_v3/data/gt_candidates/candidates_with_gt.json")
    parser.add_argument("--output-dir", default="reward_model_v3/outputs/gt_comparison")
